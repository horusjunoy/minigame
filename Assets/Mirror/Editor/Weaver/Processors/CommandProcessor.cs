...
namespace Mirror.Weaver
{
    ...
    public static class CommandProcessor
    {
        ...
        */
        ...
        {
            string cmdName = Weaver.GenerateMethodName(WeaverRuntimeNames.InvokeRpcPrefix, method);
            ...
            NetworkBehaviourProcessor.AddInvokeParameters(weaverTypes, Log, ref WeavingFailed, cmd.Parameters);
