...
namespace Mirror.Weaver
{
    ...
    public class WeaverTypes
    {
        ...
        TypeReference ImportRuntimeType(string fullName, Logger Log, ref bool WeavingFailed) =>
            Resolvers.ResolveType(assembly, resolver, Log, fullName, ref WeavingFailed);

        public TypeReference ImportRuntimeTypeReference(string fullName, Logger Log, ref bool WeavingFailed) =>
            ImportRuntimeType(fullName, Log, ref WeavingFailed);

        // constructor resolves the types and stores them in fields
        public WeaverTypes(AssemblyDefinition assembly, IAssemblyResolver resolver, Logger Log, ref bool WeavingFailed)
        {
            // system types
            ...
            weaverFuseType = ImportRuntimeType(WeaverRuntimeNames.WeaverFuse, Log, ref WeavingFailed);
            weaverFuseMethod = Resolvers.ResolveMethod(weaverFuseType, assembly, Log, "Weaved", ref WeavingFailed);

            TypeReference NetworkServerType = ImportRuntimeType(WeaverRuntimeNames.NetworkServer, Log, ref WeavingFailed);
            ...
            TypeReference NetworkClientType = ImportRuntimeType(WeaverRuntimeNames.NetworkClient, Log, ref WeavingFailed);
            ...
            TypeReference NetworkBehaviourType = ImportRuntimeType(WeaverRuntimeNames.NetworkBehaviour, Log, ref WeavingFailed);
            ...
            TypeReference RemoteProcedureCallsType = ImportRuntimeType(WeaverRuntimeNames.RemoteProcedureCalls, Log, ref WeavingFailed);
            ...
            TypeReference RemoteCallDelegateType = ImportRuntimeType(WeaverRuntimeNames.RemoteCallDelegate, Log, ref WeavingFailed);
            ...
            TypeReference NetworkWriterPoolType = ImportRuntimeType(WeaverRuntimeNames.NetworkWriterPool, Log, ref WeavingFailed);
            ...
            TypeReference readerExtensions = ImportRuntimeType(WeaverRuntimeNames.NetworkReaderExtensions, Log, ref WeavingFailed);
            readNetworkBehaviourGeneric = Resolvers.ResolveMethod(readerExtensions, assembly, Log, (md =>
            {
                return md.Name == "ReadNetworkBehaviour" &&
