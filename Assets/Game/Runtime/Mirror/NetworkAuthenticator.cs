...
namespace Mirror
{
    ...
    public abstract partial class NetworkAuthenticator : MonoBehaviour
    {
...
#if UNITY_EDITOR
    public abstract partial class NetworkAuthenticator
    {
        void Reset()
        {
            ...
            if (manager != null && manager.authenticator == null)
            {
                ...
                EditorUndo.RecordObject(manager, "Assigned NetworkManager authenticator");
                manager.authenticator = this;
            }
        }

        static class EditorUndo
        {
            static readonly Type UndoType = Type.GetType("UnityEditor.Undo, UnityEditor");
            static readonly MethodInfo RecordObjectMethod = UndoType?.GetMethod(
                "RecordObject",
            ...
            {
                if (UndoType == null || RecordObjectMethod == null)
                    return;

                RecordObjectMethod.Invoke(null, new object[] { target, name });
            }
        }
    }
#endif
