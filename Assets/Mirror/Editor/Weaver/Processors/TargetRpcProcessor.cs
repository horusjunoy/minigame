    ...
    public static class TargetRpcProcessor
    {
        ...
        public static bool HasNetworkConnectionParameter(MethodDefinition md)
        {
            if (md.Parameters.Count > 0)
            {
                ...
                return type.Is(WeaverRuntimeNames.NetworkConnection) ||
                       type.IsDerivedFrom(WeaverRuntimeNames.NetworkConnection);
            }
            return false;
        }
        ...
        {
            string trgName = Weaver.GenerateMethodName(WeaverRuntimeNames.InvokeRpcPrefix, md);
            ...
            NetworkBehaviourProcessor.AddInvokeParameters(weaverTypes, Log, ref WeavingFailed, rpc.Parameters);
            td.Methods.Add(rpc);
            return rpc;
        }
        ...
        */
        public static MethodDefinition ProcessTargetRpcCall(WeaverTypes weaverTypes, Writers writers, Logger Log, TypeDefinition td, MethodDefinition md, CustomAttribute targetRpcAttr, ref bool WeavingFailed)
        {
            ...
            NetworkBehaviourProcessor.WriteSetupLocals(worker, weaverTypes, Log, ref WeavingFailed);
