...
namespace Mirror
{
    ...
    public abstract class InterestManagementBase : MonoBehaviour
    {
        ...
        public virtual void SetHostVisibility(NetworkIdentity identity, bool visible)
        {
            ...
            SetComponentEnabledByTypeName(identity, "UnityEngine.AudioSource, UnityEngine.AudioModule", visible);
            ...
            SetComponentEnabledByTypeName(identity, "UnityEngine.ParticleSystem, UnityEngine.ParticleSystemModule", visible);
        }

        static void SetComponentEnabledByTypeName(Component root, string typeName, bool visible)
        {
            Type type = Type.GetType(typeName);
            if (type == null)
                return;

            Component[] components = root.GetComponentsInChildren(type);
