...
namespace Mirror.Weaver
{
    ...
    public class Writers
    {
        ...
        public void Register(TypeReference dataType, MethodReference methodReference)
        {
            ...
            bool priority = methodDefinition.HasCustomAttribute(WeaverRuntimeNames.WeaverPriorityAttribute);
        ...
        MethodReference GenerateWriter(TypeReference variableReference, ref bool WeavingFailed)
        {
            ...
            if (variableReference.IsArray)
            {
                ...
                return GenerateCollectionWriter(variableReference, elementType, "WriteArray", ref WeavingFailed);
            }
            ...
            if (variableReference.Is(typeof(ArraySegment<>)))
            {
                ...
                return GenerateCollectionWriter(variableReference, elementType, "WriteArraySegment", ref WeavingFailed);
            }
            if (variableReference.Is(typeof(List<>)))
            {
                ...
                return GenerateCollectionWriter(variableReference, elementType, "WriteList", ref WeavingFailed);
            }
            if (variableReference.Is(typeof(HashSet<>)))
            {
                ...
                return GenerateCollectionWriter(variableReference, elementType, "WriteHashSet", ref WeavingFailed);
            }

            // handle both NetworkBehaviour and inheritors.
            // fixes: https://github.com/MirrorNetworking/Mirror/issues/2939
            if (variableReference.IsDerivedFrom(WeaverRuntimeNames.NetworkBehaviour) || variableReference.Is(WeaverRuntimeNames.NetworkBehaviour))
            {
                return GetNetworkBehaviourWriter(variableReference, ref WeavingFailed);
            }
        ...
        MethodReference GetNetworkBehaviourWriter(TypeReference variableReference, ref bool WeavingFailed)
        {
            // all NetworkBehaviours can use the same write function
            TypeReference networkBehaviourType = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkBehaviour, Log, ref WeavingFailed);
            if (writeFuncs.TryGetValue(networkBehaviourType, out MethodReference func))
            {
        ...
        {
            MethodDefinition writerFunc = GenerateWriterFunc(variable, ref WeavingFailed);
        ...
        MethodDefinition GenerateWriterFunc(TypeReference variable, ref bool WeavingFailed)
        {
            ...
            writerFunc.Parameters.Add(new ParameterDefinition("writer", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkWriter, Log, ref WeavingFailed)));
        ...
        MethodDefinition GenerateCollectionWriter(TypeReference variable, TypeReference elementType, string writerFunction, ref bool WeavingFailed)
        {
            ...
            TypeReference readerExtensions = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkWriterExtensions, Log, ref WeavingFailed);
        ...
        internal void InitializeWriters(ILProcessor worker, ref bool WeavingFailed)
        {
            ModuleDefinition module = assembly.MainModule;

            TypeReference genericWriterClassRef = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.WriterGeneric, Log, ref WeavingFailed);

            FieldReference fieldRef = Resolvers.ResolveField(genericWriterClassRef, assembly, Log, "write", ref WeavingFailed);
            TypeReference networkWriterRef = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkWriter, Log, ref WeavingFailed);
