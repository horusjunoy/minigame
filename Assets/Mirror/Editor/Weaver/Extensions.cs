...
namespace Mirror.Weaver
{
    public static class Extensions
    {
        ...
        public static bool Is(this TypeReference td, string fullName) =>
            td.GetElementType().FullName == fullName;
        ...
        public static bool IsDerivedFrom(this TypeReference tr, string fullName)
        {
            if (tr == null)
                return false;
            ...
            try
            {
                TypeReference parent = tr.Resolve().BaseType;
                while (parent != null)
                {
                    if (parent.Is(fullName))
                        return true;
        ...
        public static bool ImplementsInterface(this TypeDefinition td, string interfaceFullName)
        {
            TypeDefinition typedef = td;

            while (typedef != null)
            {
                if (typedef.Interfaces.Any(iface => iface.InterfaceType.Is(interfaceFullName)))
                    return true;
        ...
        public static bool IsNetworkIdentityField(this TypeReference tr) =>
            ...
            tr.Is(WeaverRuntimeNames.NetworkIdentity) ||
            // handle both NetworkBehaviour and inheritors.
            // fixes: https://github.com/MirrorNetworking/Mirror/issues/2939
            tr.IsDerivedFrom(WeaverRuntimeNames.NetworkBehaviour) ||
            tr.Is(WeaverRuntimeNames.NetworkBehaviour);
        ...
        public static CustomAttribute GetCustomAttribute(this ICustomAttributeProvider method, string fullName)
        {
            return method.CustomAttributes.FirstOrDefault(ca => ca.AttributeType.FullName == fullName);
        }
        ...
        public static bool HasCustomAttribute(this ICustomAttributeProvider attributeProvider, string fullName)
        {
            return attributeProvider.CustomAttributes.Any(attr => attr.AttributeType.FullName == fullName);
        }
