    ...
    public class Readers
    {
        ...
        MethodReference GenerateReader(TypeReference variableReference, ref bool WeavingFailed)
        {
            ...
            if (variableReference.IsArray)
            {
                ...
                return GenerateReadCollection(variableReference, variableReference.GetElementType(), "ReadArray", ref WeavingFailed);
            }
            ...
            else if (variableDefinition.Is(typeof(List<>)))
            {
                ...
                return GenerateReadCollection(variableReference, elementType, "ReadList", ref WeavingFailed);
            }
            else if (variableDefinition.Is(typeof(HashSet<>)))
            {
                ...
                return GenerateReadCollection(variableReference, elementType, "ReadHashSet", ref WeavingFailed);
            }
            // handle both NetworkBehaviour and inheritors.
            // fixes: https://github.com/MirrorNetworking/Mirror/issues/2939
            else if (variableReference.IsDerivedFrom(WeaverRuntimeNames.NetworkBehaviour) || variableReference.Is(WeaverRuntimeNames.NetworkBehaviour))
            {
        ...
        {
            MethodDefinition readerFunc = GenerateReaderFunction(variable, ref WeavingFailed);
        ...
        MethodDefinition GenerateReaderFunction(TypeReference variable, ref bool WeavingFailed)
        {
            ...
            readerFunc.Parameters.Add(new ParameterDefinition("reader", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkReader, Log, ref WeavingFailed)));
        ...
        MethodDefinition GenerateReadCollection(TypeReference variable, TypeReference elementType, string readerFunction, ref bool WeavingFailed)
        {
            ...
            TypeReference readerExtensions = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkReaderExtensions, Log, ref WeavingFailed);
        ...
        internal void InitializeReaders(ILProcessor worker, ref bool WeavingFailed)
        {
            ModuleDefinition module = assembly.MainModule;

            TypeReference genericReaderClassRef = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.ReaderGeneric, Log, ref WeavingFailed);

            FieldReference fieldRef = Resolvers.ResolveField(genericReaderClassRef, assembly, Log, "read", ref WeavingFailed);
            TypeReference networkReaderRef = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkReader, Log, ref WeavingFailed);
