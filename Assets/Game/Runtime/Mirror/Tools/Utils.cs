...
namespace Mirror
{
    ...
    public static partial class Utils
    {
...
#if UNITY_EDITOR
            if (!IsSceneObjectWithPrefabParentEditor(gameObject, out prefab))
            {
                return false;
            }
#else
...
#if UNITY_EDITOR
        static bool IsPrefabEditor(GameObject obj) => EditorPrefabUtility.IsPartOfPrefabAsset(obj);

        static bool IsSceneObjectWithPrefabParentEditor(GameObject gameObject, out GameObject prefab)
        {
            if (!EditorPrefabUtility.IsPartOfPrefabInstance(gameObject))
            {
                prefab = null;
                return false;
            }

            prefab = EditorPrefabUtility.GetCorrespondingObjectFromSource(gameObject);
            if (prefab == null)
            {
        ...
        static class EditorPrefabUtility
        {
            static readonly Type PrefabUtilityType = Type.GetType("UnityEditor.PrefabUtility, UnityEditor");
            static readonly MethodInfo IsPartOfPrefabAssetMethod = PrefabUtilityType?.GetMethod(
                "IsPartOfPrefabAsset",
                BindingFlags.Public | BindingFlags.Static,
                null,
                new[] { typeof(UnityEngine.Object) },
                null);
            static readonly MethodInfo IsPartOfPrefabInstanceMethod = PrefabUtilityType?.GetMethod(
                "IsPartOfPrefabInstance",
                BindingFlags.Public | BindingFlags.Static,
                null,
                new[] { typeof(UnityEngine.Object) },
                null);
            static readonly MethodInfo GetCorrespondingObjectFromSourceMethod = PrefabUtilityType?.GetMethod(
            ...
            public static bool IsPartOfPrefabAsset(GameObject obj) =>
                PrefabUtilityType != null && IsPartOfPrefabAssetMethod != null &&
                (bool)IsPartOfPrefabAssetMethod.Invoke(null, new object[] { obj });

            public static bool IsPartOfPrefabInstance(GameObject obj) =>
                PrefabUtilityType != null && IsPartOfPrefabInstanceMethod != null &&
                (bool)IsPartOfPrefabInstanceMethod.Invoke(null, new object[] { obj });

            public static GameObject GetCorrespondingObjectFromSource(GameObject obj)
            {
                if (PrefabUtilityType == null || GetCorrespondingObjectFromSourceMethod == null)
                    return null;

                return GetCorrespondingObjectFromSourceMethod.Invoke(null, new object[] { obj }) as GameObject;
            }
        }
#endif
