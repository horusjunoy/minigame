...
namespace Mirror.Weaver
{
    ...
    class NetworkBehaviourProcessor
    {
        ...
        */
        ...
        public static void WriteSetupLocals(ILProcessor worker, WeaverTypes weaverTypes, Logger Log, ref bool WeavingFailed)
        {
            worker.Body.InitLocals = true;
            TypeReference writerPooledType = weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkWriterPooled, Log, ref WeavingFailed);
            worker.Body.Variables.Add(new VariableDefinition(writerPooledType));
        }
        ...
        */
        ...
        void GenerateSerialization(ref bool WeavingFailed)
        {
            ...
            serialize.Parameters.Add(new ParameterDefinition("writer", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkWriter, Log, ref WeavingFailed)));
            ...
            foreach (FieldDefinition syncVarDef in syncVars)
            {
                ...
                if (syncVar.FieldType.IsDerivedFrom(WeaverRuntimeNames.NetworkBehaviour))
                {
                    writeFunc = writers.GetWriteFunc(weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkBehaviour, Log, ref WeavingFailed), ref WeavingFailed);
                }
                else
                {
        ...
        void DeserializeField(FieldDefinition syncVar, ILProcessor worker, ref bool WeavingFailed)
        {
            ...
            else if (syncVar.FieldType.Is(WeaverRuntimeNames.NetworkIdentity))
            {
                // reader
                worker.Emit(OpCodes.Ldarg_1);
            ...
            else if (syncVar.FieldType.IsDerivedFrom(WeaverRuntimeNames.NetworkBehaviour) || syncVar.FieldType.Is(WeaverRuntimeNames.NetworkBehaviour))
            {
                // reader
                worker.Emit(OpCodes.Ldarg_1);
        ...
        void GenerateDeSerialization(ref bool WeavingFailed)
        {
            ...
            serialize.Parameters.Add(new ParameterDefinition("reader", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkReader, Log, ref WeavingFailed)));
        ...
        public static void AddInvokeParameters(WeaverTypes weaverTypes, Logger Log, ref bool WeavingFailed, ICollection<ParameterDefinition> collection)
        {
            collection.Add(new ParameterDefinition("obj", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkBehaviour, Log, ref WeavingFailed)));
            collection.Add(new ParameterDefinition("reader", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkReader, Log, ref WeavingFailed)));
            // senderConnection is only used for commands but NetworkBehaviour.CmdDelegate is used for all remote calls
            collection.Add(new ParameterDefinition("senderConnection", ParameterAttributes.None, weaverTypes.ImportRuntimeTypeReference(WeaverRuntimeNames.NetworkConnectionToClient, Log, ref WeavingFailed)));
        }
        ...
        bool ValidateParameter(MethodReference method, ParameterDefinition param, RemoteCallType callType, bool firstParam, ref bool WeavingFailed)
        {
            ...
            bool isNetworkConnection = param.ParameterType.Is(WeaverRuntimeNames.NetworkConnection);
        ...
        public static bool IsSenderConnection(ParameterDefinition param, RemoteCallType callType)
        {
            ...
            return type.Is(WeaverRuntimeNames.NetworkConnectionToClient)
                || type.IsDerivedFrom(WeaverRuntimeNames.NetworkConnectionToClient);
        }
        ...
        void ProcessMethods(ref bool WeavingFailed)
        {
            ...
            foreach (MethodDefinition md in methods)
            {
                ...
                {
                    if (ca.AttributeType.Is(WeaverRuntimeNames.CommandAttribute))
                    {
                        ProcessCommand(names, md, ca, ref WeavingFailed);
                        break;
                    }

                    if (ca.AttributeType.Is(WeaverRuntimeNames.TargetRpcAttribute))
                    {
                        ProcessTargetRpc(names, md, ca, ref WeavingFailed);
                        break;
                    }

                    if (ca.AttributeType.Is(WeaverRuntimeNames.ClientRpcAttribute))
                    {
